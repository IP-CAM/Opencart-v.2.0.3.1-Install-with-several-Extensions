...
class ModelPaymentPostforskott extends Model {
	...
	public function getMethod($address, $total) {
		...
		if ($status) {
			...
			$title = sprintf($this->language->get('text_title'), $this->currency->format($this->tax->calculate($fee, $this->config->get($this->name . '_tax_class_id'), $this->config->get('config_tax'))));
