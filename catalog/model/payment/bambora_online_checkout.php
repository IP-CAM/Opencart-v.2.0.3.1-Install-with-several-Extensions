 ...
 *
 */
class ModelPaymentBamboraOnlineCheckout extends Model
{
    ...
    public function addDbTransaction($orderId, $transactionId, $amount, $currency)
    {
        try {
         ...
         ");
            ...
            throw new Exception("Could not add the transaction to the database. Possible duplicate entry txnid: {$transactionId} and orderId: {$orderId}");
        }
