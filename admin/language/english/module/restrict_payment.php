...
// Heading
//------------------------------------------------------------------------------
$_['heading_title']						= $name . ' ' . $type . ' Methods';
...
$_['help_restrictions']					= 'By default, payment methods are available based on their own settings. Use "Rules" to further restrict when they are available, based on specific criteria such as geo zone or customer group.';
$_['heading_restrictions']				= 'Restrictions';

$_['column_action']						= 'Action';
$_['column_group']						= 'Name';
$_['column_method']						= 'Payment Methods';
...
$_['help_restriction_methods']			= 'Select the payment methods to restrict. These methods will only be available when all rules are met.';
...
$_['text_cheapest_subtotal']			= 'Cheapest Product Total';
...
//------------------------------------------------------------------------------
$_['help_total_value']					= 'The cart&#39;s Sub-Total is normally used for calculations involving the total. To change this, use one of the following:<br /><br />&bull; <b>Pre-Discounted Sub-Total:</b> the sub-total of all products&#39; original prices, ignoring Special or Discount prices<br /><br />&bull; <b>Non-Discounted Sub-Total:</b> the sub-total not including products with Special or Discount pricing<br /><br />&bull; <b>Shipping Cost:</b> the cost of the shipping option selected by the customer<br /><br />&bull; <b>Taxed Sub-Total:</b> the sub-total including any tax on products<br /><br />&bull; <b>Total:</b> the total at the relative Sort Order of ' . ($type == 'Shipping' ? 'the "Shipping" Order Total<br /><br />Products that do not require shipping are NOT included in values based on the sub-total.' : 'this extension.');
?>