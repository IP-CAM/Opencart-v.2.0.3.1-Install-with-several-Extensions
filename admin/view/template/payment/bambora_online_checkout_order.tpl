<div class="alert alert-danger" id="bambora-online-checkout-error-message" style="display:none;"></div>
...
function getTransactionInformation() {
    ...
    $.ajax({
        url: 'index.php?route=payment/bambora_online_checkout/getPaymentTransaction&token=<?php echo $token; ?>',
        dataType: 'html',
        data: {
