				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="tab-settings">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input name="postforskott_total_min" id="input-total_min" class="form-control" value="<?php echo $postforskott_total_min; ?>" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input name="postforskott_total_max" id="input-total_max" class="form-control" value="<?php echo $postforskott_total_max; ?>" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input name="postforskott_fee" id="input-fee" class="form-control" value="<?php echo $postforskott_fee; ?>" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="postforskott_tax_class_id" id="input-tax_class_id" class="form-control">
									<option value="0"><?php echo $text_none; ?></option>
									<?php foreach ($tax_classes as $tax_class) { ?>
										<?php if ($tax_class['tax_class_id'] == $postforskott_tax_class_id) { ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="postforskott_customer_group_id" id="input-customer_group_id" class="form-control">
									<option value="0"><?php echo $text_select_all; ?></option>
									<?php foreach ($customer_groups as $customer_group) { ?>
										<?php if ($customer_group['customer_group_id'] == $postforskott_customer_group_id) { ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="postforskott_geo_zone_id" id="input-geo_zone_id" class="form-control">
									<option value="0"><?php echo $text_all_zones; ?></option>
									<?php foreach ($geo_zones as $geo_zone) { ?>
										<?php if ($geo_zone['geo_zone_id'] == $postforskott_geo_zone_id) { ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="postforskott_order_status_id" id="input-order_status_id" class="form-control">
									<?php foreach ($order_statuses as $order_status) { ?>
										<?php if ($order_status['order_status_id'] == $postforskott_order_status_id) { ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="postforskott_status" id="input-status" class="form-control">
									<?php if ($postforskott_status) { ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input name="postforskott_sort_order" id="input-sort_order" class="form-control" value="<?php echo $postforskott_sort_order; ?>" />
							</div>
						</div>
