				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="tab-settings">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="postforskott_fee_status" id="input-status" class="form-control">
									<?php if ($postforskott_fee_status) { ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input name="postforskott_fee_sort_order" id="input-sort_order" class="form-control" value="<?php echo $postforskott_fee_sort_order; ?>" />
							</div>
						</div>
