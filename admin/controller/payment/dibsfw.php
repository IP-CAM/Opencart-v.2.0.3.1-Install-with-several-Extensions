...
class ControllerPaymentDibsfw extends Controller {
	...
	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
        ...
        $data['entry_text_title_description'] = $this->language->get('entry_text_title_description');
        ...
        $data['entry_mid_description'] = $this->language->get('entry_mid_description');
        ...
        $data['entry_key1_description'] = $this->language->get('entry_key1_description');
        $data['entry_key2_description'] = $this->language->get('entry_key2_description');
        ...
        $data['entry_distrtype_description'] = $this->language->get('entry_distrtype_description');
        ...
        $data['entry_capturenow_description'] = $this->language->get('entry_capturenow_description');
        
        $data['dibsfw_capturenow'] = $this->language->get('dibsfw_capturenow');
        $data['entry_paytype'] = $this->language->get('entry_paytype');
        $data['entry_paytype_description'] = $this->language->get('entry_paytype_description');
        ...
        $data['entry_lang_description'] = $this->language->get('entry_lang_description');
        ...
        $data['entry_account_description'] = $this->language->get('entry_account_description');
        $data['entry_decorator'] = $this->language->get('entry_decorator');
        $data['entry_decorator_description'] = $this->language->get('entry_decorator_description');
        ...
        $data['entry_order_status_id_description'] = $this->language->get('entry_order_status_id_description');
