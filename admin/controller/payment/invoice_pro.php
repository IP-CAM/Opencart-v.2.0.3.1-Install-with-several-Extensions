...
class ControllerPaymentInvoicePro extends Controller {
	...
	public function index() {
		...
		$data['entry_reg_exp'] 				= $this->language->get('entry_reg_exp');
		...
		$data['help_reg_exp'] 				= $this->language->get('help_reg_exp');
		$data['help_validation'] 			= $this->language->get('help_validation');
		...
		// LOAD MODEL AND GET TEX CLASESS
		...
		$fields = array(
			...
			'total_max'				=> '0',
			'fee'					=> '0',
			'reg_exp'				=> '/\b(((20)((0[0-9])|(1[0-1])))|(([1][^0-8])?\d{2}))((0[1-9])|1[0-2])((0[1-9])|(2[0-9])|(3[01]))[-+]?\d{4}[,.]?\b/',
			'ssn'					=> '0',
			'tax_class_id'			=> '0',
