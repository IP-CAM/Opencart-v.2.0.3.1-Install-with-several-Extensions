	...
	private function __databaseFix() {
		...
		if (!$query->num_rows) {
			...
			$urls = array(
				...
				'2' => array( /* slovak = 2 (language_id) */
					'account/login'        => 'prihlasenie',
					'account/register'     => 'registracia',
					'account/account'      => 'moj-ucet',
					'account/edit'         => 'uprava-profilu',
					'account/password'     => 'zmena-hesla',
					'account/forgotten'    => 'strata-hesla',
					'account/address'      => 'zoznam-adries',
					'account/order'        => 'historia-objednavok',
					'account/wishlist'     => 'zoznam-priani',
					'account/download'     => 'subory-na-stiahnutie',
					'account/return'       => 'reklamacie',
					'account/return/add'   => 'pridat-reklamaciu',
					'account/voucher'      => 'darcekove-poukazy',
					'account/newsletter'   => 'newsletter',
					'account/reward'       => 'body-za-nakup',
					'account/transaction'  => 'transakcie',
					'account/recurring'    => 'opakovane-platby',
					'affiliate/account'    => 'affiliates',
					'checkout/cart'        => 'nakupny-kosik',
					'checkout/checkout'    => 'pokladna',
					'product/special'      => 'specialne-ponuky',
					'product/search'       => 'vyhladavanie-produktov',
					'product/manufacturer' => 'vyrobcovia',
					'information/contact'  => 'kontaktujte-nas',
					'information/sitemap'  => 'mapa-stranky',
				),
				'2' => array( /* dutch = 2 (language_id) */
					'account/login'        => 'login',
					'account/register'     => 'registeren',
					'account/account'      => 'account',
					'account/edit'         => 'account-bewerken',
					'account/password'     => 'wachtwoord',
					'account/forgotten'    => 'vergeten',
					'account/address'      => 'adres',
					'account/order'        => 'bestel-geschiedenis',
					'account/wishlist'     => 'verlanglijst',
					'account/download'     => 'download',
					'account/return'       => 'terug',
					'account/return/add'   => 'toevoegen',
					'account/voucher'      => 'cadeaubon',
					'account/newsletter'   => 'nieuwsbrief',
					'account/reward'       => 'beloning',
					'account/transaction'  => 'transactie',
					'account/recurring'    => 'terugkeren',
					'affiliate/account'    => 'affiliates',
					'checkout/cart'        => 'winkelwagen',
					'checkout/checkout'    => 'afrekenen',
					'product/special'      => 'aanbieding',
