...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_default_sort'] = $this->language->get('entry_default_sort');	
		$data['help_default_sort'] = $this->language->get('help_default_sort');

		if (isset($this->request->post['config_default_sort'])) {
			$data['config_default_sort'] = $this->request->post['config_default_sort'];
		} else {
			$data['config_default_sort'] = $this->config->get('config_default_sort');
		}			
