...
$data['seo_pp_auto_category_seo_url'] = intval($this->config->get('seo_pp_auto_category_seo_url'));
				$data['seo_pp_auto_category_meta_tag_title'] = intval($this->config->get('seo_pp_auto_category_meta_tag_title'));
				$data['seo_pp_auto_category_meta_tag_description'] = intval($this->config->get('seo_pp_auto_category_meta_tag_description'));
				$data['seo_pp_auto_category_meta_tag_keywords'] = intval($this->config->get('seo_pp_auto_category_meta_tag_keywords'));
...
if(isset($this->request->get['category_id'])){
					...
					$data['keywords'] = $this->model_catalog_url_alias->getAllUrlAlias('category_id', $this->request->get['category_id']);
				} else {
					$data['keywords'] = array();
				}
