...
$data['seo_pp_auto_information_meta_title'] = intval($this->config->get('seo_pp_auto_information_meta_title'));
				$data['seo_pp_auto_information_meta_desc'] = intval($this->config->get('seo_pp_auto_information_meta_desc'));
				$data['seo_pp_auto_information_seo_url'] = intval($this->config->get('seo_pp_auto_information_seo_url'));
...
if(isset($this->request->get['information_id'])){
					...
					$data['keywords'] = $this->model_catalog_url_alias->getAllUrlAlias('information_id', $this->request->get['information_id']);
				} else {
					$data['keywords'] = array();
				}
