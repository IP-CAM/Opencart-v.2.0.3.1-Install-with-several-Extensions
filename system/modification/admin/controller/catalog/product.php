...
$data['seo_pp_auto_product_relpro'] = intval($this->config->get('seo_pp_auto_product_relpro'));
				$data['seo_pp_auto_product_seo_url'] = intval($this->config->get('seo_pp_auto_product_seo_url'));
				$data['seo_pp_auto_product_tags'] = intval($this->config->get('seo_pp_auto_product_tags'));
				$data['seo_pp_auto_product_meta_description'] = intval($this->config->get('seo_pp_auto_product_meta_description'));
				$data['seo_pp_auto_product_meta_keyword'] = intval($this->config->get('seo_pp_auto_product_meta_keyword'));
				$data['seo_pp_auto_product_meta_title'] = intval($this->config->get('seo_pp_auto_product_meta_title'));
...
if(isset($this->request->get['product_id'])){
					...
					$data['keywords'] = $this->model_catalog_url_alias->getAllUrlAlias('product_id',$this->request->get['product_id']);
				} else {
					$data['keywords'] = array();
				}
	...
	protected function validateForm() {
		...
		if ((utf8_strlen($this->request->post['model']) < 1) || (utf8_strlen($this->request->post['model']) > 64)) {
			$this->error['model'] = $this->language->get('error_model');
				...
				foreach($this->request->post['keywords'] as $language_id => $keyword){
					if (utf8_strlen($keyword) > 0) {
						$this->load->model('catalog/url_alias');

						$url_alias_info = $this->model_catalog_url_alias->getUrlAliasByLanguage($keyword, $language_id);
				...
				if (false && utf8_strlen($this->request->post['keyword']) > 0) {
