      ...
      <div class="panel-body">
        <form class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="col-sm-10">
              <select name="zone_id" id="input-payment-zone" style="display: none;"><option selected="selected" value="0" ></option>
              </select>
            </div>
              <?php foreach ($custom_fields as $custom_field) { ?>
            ...
            <div class="col-sm-10">
              <select name="zone_id" id="input-shipping-zone" style="display: none;"><option selected="selected" value="0" ></option>
              </select>
            </div>
              <?php foreach ($custom_fields as $custom_field) { ?>
              <?php if ($custom_field['location'] == 'address') { ?>
