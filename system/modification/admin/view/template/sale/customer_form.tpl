                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group required">
                        ...
                        <div class="col-sm-10"><select name="address[<?php echo $address_row; ?>][zone_id]" style="display: none;"><option selected="selected" value="0" ></option></select></div>
                      <?php foreach ($custom_fields as $custom_field) { ?>
...
function addAddress() {
	...
	html += '    <div class="col-sm-10"><select name="address[' + address_row + '][zone_id]" id="input-zone' + address_row + '" style="display: none;"><option selected="selected" value="0" ></option></select></div>';
