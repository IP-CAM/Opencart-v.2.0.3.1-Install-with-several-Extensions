          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-default-sort-order"><span data-toggle="tooltip" title="<?php echo $help_default_sort; ?>"><?php echo $entry_default_sort; ?></span></label>
                  <div class="col-sm-10">
                    <select name="config_default_sort" id="input-default-sort-order" class="form-control">
                      <?php foreach ($sorts as $sort) { ?>
                      <?php if ($sort['value'] == $config_default_sort) { ?>
