      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-manufacturer" class="form-horizontal">
          ...
          <div class="form-group">
			...
			<?php if(intval($seo_pp_auto_manufacturers_seo_url)==0){ ?>
			<input type="text" name="keyword" value="<?php echo $keyword; ?>" placeholder="<?php echo $entry_keyword; ?>" id="input-keyword" class="form-control" />
			<?php } else { ?>
              <input readonly="readonly" type="text" name="dummy_keyword" value="<?php echo $keyword; ?>" placeholder="<?php echo $entry_keyword; ?>" id="input-keyword" class="form-control" />
              <input type="hidden" name="keyword" value="auto" />
          	<?php } ?>
			
              
			<?php if (intval($seo_pp_auto_manufacturers_seo_url)==0 && $error_keyword) { ?>
