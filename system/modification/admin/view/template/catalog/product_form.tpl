          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
				...
				<input type="text" 
					<?php if(intval($seo_pp_auto_product_meta_title)==1){ ?>
					readonly="readonly" name="product_description_dummy[<?php echo $language['language_id']; ?>][meta_title]" 
					<?php } else { ?>
					name="product_description[<?php echo $language['language_id']; ?>][meta_title]"
					<?php } ?>
					value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_title'] : ''; ?>" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
					<?php if(intval($seo_pp_auto_product_meta_title)==1){ ?>
					<input type="hidden" name="product_description[<?php echo $language['language_id']; ?>][meta_title]" value="auto" />
          			<?php } ?>
			
                      
			<?php if (intval($seo_pp_auto_product_meta_title)==0 && isset($error_meta_title[$language['language_id']])) { ?>
				...
				<textarea 
					<?php if(intval($seo_pp_auto_product_meta_description)==1){ ?>
					readonly="readonly" name="product_description_dummy[<?php echo $language['language_id']; ?>][meta_description]" 
					<?php } else { ?>
					name="product_description[<?php echo $language['language_id']; ?>][meta_description]"
					<?php } ?>
					rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
					<?php if(intval($seo_pp_auto_product_meta_description)==1){ ?>
						<textarea style="display:none;" name="product_description[<?php echo $language['language_id']; ?>][meta_description]">auto</textarea>
          			<?php } ?>
				...
				<textarea 
					<?php if(intval($seo_pp_auto_product_meta_keyword)==1){ ?>
					readonly="readonly" name="product_description_dummy[<?php echo $language['language_id']; ?>][meta_keyword]" 
					<?php } else { ?>
					name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]"
					<?php } ?>
					rows="5" placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
					<?php if(intval($seo_pp_auto_product_meta_keyword)==1){ ?>
					<textarea style="display:none;" name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]">auto</textarea>
          			<?php } ?>
				...
				<input type="text" 
					<?php if(intval($seo_pp_auto_product_tags)==1){ ?>
					readonly="readonly" name="product_description_dummy[<?php echo $language['language_id']; ?>][tag]" 
					<?php } else { ?>
					...
					<?php if(intval($seo_pp_auto_product_tags)==1){ ?>
						<input type="hidden" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="auto" />
          			<?php } ?>
            ...
            <div class="tab-pane" id="tab-data">
          	...
          	<?php if(intval($seo_pp_auto_product_seo_url)==0){ ?>
				<?php 
				foreach ($languages as $language) { 
				$keyword = isset($keywords[$language['language_id']])?$keywords[$language['language_id']]:'';
				?>
					<div class="input-group">
		  				<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
		  				<input type="text" name="keywords[<?=$language['language_id']?>]" value="<?php echo $keyword; ?>" placeholder="<?php echo $entry_keyword; ?>" class="form-control" />
			...
			<?php } else { ?>
				...
				?>
					<div class="input-group">
		  				<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
		  				<input readonly="readonly" type="text" name="keywords[<?=$language['language_id']?>]" value="<?php echo $keyword; ?>" placeholder="<?php echo $entry_keyword; ?>" class="form-control" />
		  				<span class="input-group-addon"><?php echo $language['name']; ?></span>
					</div>
					<?php if(isset($error_keyword[$language['language_id']])){ ?>
					<div class="text-danger"><?=$error_keyword[$language['language_id']]?></div>
			...
			<?php if (intval($seo_pp_auto_product_seo_url)==0 && $error_keyword) { ?>
