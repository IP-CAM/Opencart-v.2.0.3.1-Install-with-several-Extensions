          ...
          <div class="tab-content">
            <div class="tab-pane active in" id="tab-general">
              ...
              <div class="tab-content">
				...
				<input type="text" 
					<?php if(intval($seo_pp_auto_category_meta_tag_title)==1){ ?>
					readonly="readonly" name="category_description_dummy[<?php echo $language['language_id']; ?>][meta_title]" 
					<?php } else { ?>
					name="category_description[<?php echo $language['language_id']; ?>][meta_title]"
					<?php } ?>
					value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_title'] : ''; ?>" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
					<?php if(intval($seo_pp_auto_category_meta_tag_title)==1){ ?>
            		<input type="hidden" name="category_description[<?php echo $language['language_id']; ?>][meta_title]" value="auto" />
          			<?php } ?>
			
                      
			<?php if (intval($seo_pp_auto_category_meta_tag_title)==0 && isset($error_meta_title[$language['language_id']])) { ?>
				...
				<textarea 
					<?php if(intval($seo_pp_auto_category_meta_tag_description)==1){ ?>
					readonly="readonly" name="category_description_dummy[<?php echo $language['language_id']; ?>][meta_description]" 
					<?php } else { ?>
					name="category_description[<?php echo $language['language_id']; ?>][meta_description]"
					<?php } ?>
					rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
					<?php if(intval($seo_pp_auto_category_meta_tag_description)==1){ ?>
					<textarea style="display:none" name="category_description[<?php echo $language['language_id']; ?>][meta_description]">auto</textarea>
          			<?php } ?>
				...
				<textarea 
					<?php if(intval($seo_pp_auto_category_meta_tag_keywords)==1){ ?>
					readonly="readonly" name="category_description_dummy[<?php echo $language['language_id']; ?>][meta_keyword]" 
					<?php } else { ?>
					name="category_description[<?php echo $language['language_id']; ?>][meta_keyword]"
					<?php } ?>
					rows="5" placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
				<?php if(intval($seo_pp_auto_category_meta_tag_keywords)==1){ ?>
				<textarea style="display:none" name="category_description[<?php echo $language['language_id']; ?>][meta_keyword]">auto</textarea>
          		<?php } ?>
            ...
            <div class="tab-pane fade" id="tab-data">
          	...
          	<?php if(intval($seo_pp_auto_category_seo_url)==0){ ?>
				<?php 
			...
			<?php if (intval($seo_pp_auto_category_seo_url)==0 && $error_keyword) { ?>
