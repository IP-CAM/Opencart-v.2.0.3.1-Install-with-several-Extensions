          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
				...
				<input 
					<?php if(intval($seo_pp_auto_information_meta_title)==1){ ?>
					readonly="readonly" type="text" name="information_description_dummy[<?php echo $language['language_id']; ?>][meta_title]" 
					<?php } else { ?>
					name="information_description[<?php echo $language['language_id']; ?>][meta_title]"
					<?php } ?>
					value="<?php echo isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['meta_title'] : ''; ?>" placeholder="<?php echo $entry_meta_title; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
				<?php if(intval($seo_pp_auto_information_meta_title)==1){ ?>
				<input type="hidden" name="information_description[<?php echo $language['language_id']; ?>][meta_title]" value="auto" />
			<?php } ?>
			
                      
				<?php if (intval($seo_pp_auto_information_meta_title)==0 && isset($error_meta_title[$language['language_id']])) { ?>
				...
				<textarea 
					<?php if(intval($seo_pp_auto_information_meta_desc)==1){ ?>
					readonly="readonly" name="information_description_dummy[<?php echo $language['language_id']; ?>][meta_description]" 
					<?php } else { ?>
					name="information_description[<?php echo $language['language_id']; ?>][meta_description]"
					<?php } ?>
					rows="5" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                <?php if(intval($seo_pp_auto_information_meta_desc)==1){ ?>
                <textarea style="display:none;" name="information_description[<?php echo $language['language_id']; ?>][meta_description]" rows="5">auto</textarea>
          	<?php } ?>
			...
			<?php if(intval($seo_pp_auto_information_seo_url)==0){ ?>
				<?php 
			...
			<?php if (intval($seo_pp_auto_information_seo_url)==0 && $error_keyword) { ?>
